...
public class GroupBanListAdapter extends BaseAdapter {
    ...
    public GroupBanListAdapter(Context context, GroupMemberBean[] listBeans, boolean isAdmin, String groupCode) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            if(isAdmin) {
                GroupBanListElementForAdmin elementView;
                if(convertView == null) {
                    elementView = new GroupBanListElementForAdmin(this.context, listBeans[position].getId(), groupCode);
                } else {
                    elementView = (GroupBanListElementForAdmin) convertView;
                }
